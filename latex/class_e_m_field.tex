...
{\footnotesize\ttfamily vector$<$pair$<$\hyperlink{class_antenna}{Antenna}$\ast$, double$>$ $>$ E\+M\+Field\+::get\+In\+Range\+Antennas (\begin{DoxyParamCaption}\item[{const Point $\ast$}]{p,  }\item[{const double}]{threshold,  }\item[{const Holdable\+Agent\+::\+C\+O\+N\+N\+E\+C\+T\+I\+O\+N\+\_\+\+T\+Y\+PE}]{conn\+Type,  }\item[{unsigned long}]{mno\+Id }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool E\+M\+Field\+::is\+Antenna\+In\+Range (\begin{DoxyParamCaption}\item[{const Point $\ast$}]{p,  }\item[{\hyperlink{class_antenna}{Antenna} $\ast$}]{a,  }\item[{const double}]{threshold,  }\item[{const Holdable\+Agent\+::\+C\+O\+N\+N\+E\+C\+T\+I\+O\+N\+\_\+\+T\+Y\+PE}]{conn\+Type }\end{DoxyParamCaption})}
