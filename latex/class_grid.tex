...
\index{Grid@{Grid}!use\+Network\+Prior@{use\+Network\+Prior}}
\index{use\+Network\+Prior@{use\+Network\+Prior}!Grid@{Grid}}
...
\index{Grid@{Grid}!use\+Uniform\+Prior@{use\+Uniform\+Prior}}
\index{use\+Uniform\+Prior@{use\+Uniform\+Prior}!Grid@{Grid}}
\subsubsection{\texorpdfstring{use\+Uniform\+Prior()}{useUniformPrior()}}
...
\item 
include/\hyperlink{_grid_8h}{Grid.\+h}\end{DoxyCompactItemize}
