...
/**
 * This class extends the Agent class and adds location on a map. It has methods to set and get the location on the map
...
public:
	 ...
	 * @param initLocation a pointer to a Point object representing the initial location of the object.
	 ...
	 * @return a string object containing the id and the coordinates of the location of the agent.
	 */
	 ...
	 * @return a string representation of the location, containing the values of the coordinates of the location.
	 */
