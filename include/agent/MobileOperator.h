 ...
 * file and two \code{ofstream} members representing the files where the cell boundaries and signal strength/dominance are saved for all
...
public:
	/**
	 * Constructor of this class. It builds a \code{MobileOperator} object with the characteristics provided by user through the
	 * parameters. of the constructor.
	 * It builds a string representing the name of the file where the coverage area of all the antennas (cell boundary)
	 ...
	 * contains the antenna id followed by a \code{wkt} text representing the coverage area of antenna.
	 ...
	 * to this MobileOperator are saved. The signal strength/dominance is computed in the center of each tile of the \code{Grid}
	 ...
	 * @param m a pointer to a \code{Map} object of the simulation.
	 ...
	 * @param detailed this parameter has no effect for the \code{MobileOperator} class.
	 * @return a \code{string} that describes the parameters of the MobieOperator. This \code{string} contains the id of the \code{MobileOperator}
	 * object and its name.
	 */
	const string toString(bool detailed = false) const override;

	/**
	 * Returns the header of the string representation of \code{MobileOperator} objects.
	 * @return the header of the string representation of \code{MobileOperator} objects.
	 */
	static const string getHeader();

	/**
	 * The name of the Mobile Operator. This name is read from the simulation configuration file and it si provided as a paramter
	 ...
	 * @return a \code{ofstream} object representing the file where the coverage area of all the antennas that belong to this
	 * \code{MobileOperator} are saved in csv format.
	 */
	ofstream& getAntennaCellsFile();

	/**
	 * Returns the file where the signal strength/dominance values are saved in .csv format.
	 * @return a \code{ofstream} representing the file where the signal strength/dominance values for all antennas
