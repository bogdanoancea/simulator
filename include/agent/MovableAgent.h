...
/**
 * This class represents an Agent that can move on the map. This is an abstract class. It is used as a base class for all
 * agents that can move. Currently only the Person, MobilePhone, and Tablet classes inherits it and are already implemented.
 */
...
public:
	 ...
	 * from a configuration file. For example, for the Person class, this value is specified in the persons configuration file.
	 */
	...
	/**
	 * Builds a string with the most relevant information of the class. It is useful to output the description of concrete agents
	 ...
	 * @return a string object containing the id, the coordinates of the location of the agent and the initial speed of movement.
	 */
	 ...
	 * this function. The actual implementation is based on a Strategy design pattern. Displace class defines the displacement strategy
