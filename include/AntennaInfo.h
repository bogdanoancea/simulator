...
public:
	...
	/**
	 * Constructor of the class. It builds an object with member values given by the arguments of the constructor.
	 * @param line a string object that contains the comma separated values of the parameters of an event, read from the csv files generated by each
	 * antenna during simulation.
	 */
	AntennaInfo(string line);
	/**
	 ...
	 * timestamp value of the first object is less than the timestamp of the second one.
	 */
	 ...
	 * Overloaded operator to compare to objects
	 * @param ai the other object to compare to.
	 * @return true if this object is greater than ai, false otherwise. An object is greater than another object if the
	 * timestamp value of the first object is greater than the timestamp of the second one.
	 */
	bool operator > (const AntennaInfo& ai) const;
